...
class _SearchScreenState extends State<SearchScreen> {
  ...
  var response = await http.get(Uri.parse('$BASE_URL_LOCAL/v1/product?product_name=$_searchTerm'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _searchResults.isNotEmpty ? GridView.builder(
    ...
    : Center(
      child: Text('Không tìm thấy kết quả cho: $_searchTerm'),
    ),
    );
  }
}
